        ...
        private void LoadNotifications()
        {
            ...
            using (SqlConnection conn = new SqlConnection(DBConnection.ConnectionString))
            {
                ...
                string query = @"SELECT 
                         ...
                         INNER JOIN Users U ON PR.SellerID = U.UserID
                         WHERE PR.BuyerID = @BuyerID
                ...
                using (SqlCommand cmd = new SqlCommand(query, conn))
                {
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            string sellerFullName = reader["SellerName"].ToString();
                            ...
                            sellerName.Text = sellerFullName.ToUpper();
                            sellerName.Left = 15;
                            sellerName.Top = 225;
                            ...
                            price.Text = "₱" + artworkPrice.ToString("0.##");
                            price.Left = 15;
                            price.Top = 248;
                            price.Width = 65;
                            price.Height = 25;
                            ...
                            status.Text = statusText.ToUpper();
